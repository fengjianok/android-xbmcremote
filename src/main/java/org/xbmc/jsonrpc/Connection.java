/*
 * Copyright (C) 2005-2010 Team XBMC http://xbmc.org
 * 
 ...
 * 
 * You should have received a copy of the GNU General Public License along with XBMC Remote; see the file license. If not, write to the Free
 * Software Foundation, 675 Mass Ave, Cambridge, MA 02139, USA. http://www.gnu.org/copyleft/gpl.html
 */
...
public class Connection {
  ...
  /**
   * Returns the singleton instance of this connection. Note that host and port settings are only looked at the first time. Use {@link
   * setHost()} if you want to update these parameters.
   * 
  ...
  /**
   * Complete URL without any attached command parameters, for instance: <code>http://192.168.0.10:8080</code>
   */
  ...
  /**
   * Executes an JSON-RPC method without parameters and returns the result from a field as boolean.
   * 
  ...
  /**
   * Executes an JSON-RPC method without parameter and returns the result from a field as integer.
   * 
   * @param manager Upper layer reference for error posting
   * @param method Name of the method to run
   * @param returnField Name of the field to return
  ...
  /**
   * Executes a JSON-RPC command without parameters and returns the result as JSON object.
   * 
   * @param manager Upper layer reference for error posting
   * @param method Name of the method to run
   * @return Result
